...
> Build an NLP-powered chatbot that can answer common financial queries about taxation, mutual funds, insurance, and government schemes in simple language.
...
- Understands natural human language (NLP)
- Provides accurate and easy-to-read answers about Indian finance
- Can maintain a short chat history for context
- Allows users to clear chat history
- Runs completely in a browser without needing a database
...
✅ **No Database Needed:** Temporary in-memory storage for quick use and privacy  
